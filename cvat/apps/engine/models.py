...
class Catlog(models.Model):
    signid = models.IntegerField()
    signname = models.TextField(blank=True)
    projectid = models.IntegerField()
    imagepath = models.TextField(blank=True)
    description = models.TextField(blank=True)
    group_image = models.TextField(blank=True)
    label_mode_dev = models.TextField(blank=True)
    label_mode_eva = models.TextField(blank=True)
